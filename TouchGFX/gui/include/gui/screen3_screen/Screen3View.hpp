...
public:
    ...
    // Code tự viết: TouchGFX gọi mỗi tick để đọc input và cập nhật game hai người.
    virtual void handleTickEvent() override;

    // Code tự viết: Input bàn phím chỉ dùng khi chạy TouchGFX simulator.
...
protected:
    ...
    // Code tự viết: Trạng thái của đội hình alien.
    ...
    // Code tự viết: Đạn riêng của người chơi 2.
    touchgfx::Box ship2Bullet;

    // Code tự viết: Các hàm xử lý gameplay hai người.
    void spawnBullet();
