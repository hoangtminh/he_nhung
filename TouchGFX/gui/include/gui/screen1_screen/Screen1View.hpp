...
{
public:
    GameOverWidget() : visible(false), isVictory(false), score(0)
    {
    ...
    virtual void draw(const touchgfx::Rect& invalidatedArea) const override
    {
        ...
        if (isVictory)
        {
            ...
            PixelFont::drawText(*this, invalidatedArea, scoreBuf, scoreX, 30, 2, whiteColor);

            // Draw PRESS BTN TO RESTART in White
            PixelFont::drawText(*this, invalidatedArea, "PRESS BTN TO RESTART", 40, 52, 1, whiteColor);
        }
        else
        {
            // Draw GAME OVER in Red
            touchgfx::colortype redColor = touchgfx::Color::getColorFromRGB(255, 0, 0);
            PixelFont::drawText(*this, invalidatedArea, "GAME OVER", 44, 15, 2, redColor);

            // Draw PRESS BTN TO RESTART in White
            touchgfx::colortype whiteColor = touchgfx::Color::getColorFromRGB(255, 255, 255);
            PixelFont::drawText(*this, invalidatedArea, "PRESS BTN TO RESTART", 40, 40, 1, whiteColor);
        }
    }
